...
.PHONY: help up down logs ps build test lint fmt check smoke seed kafka-topics kafka-test check-structure tree openapi-summary compose-up compose-down topics-create kafka-topology terraform-fmt-check go-build go-test
